...
function MapboxComponent({ longitude = 80.2347674371034, latitude = 26.514380378501553 }) {
    ...
    const [ userLocation, setUserLocation ] = useState({latitude: 26.514380378501553, longitude: 80.2347674371034});
