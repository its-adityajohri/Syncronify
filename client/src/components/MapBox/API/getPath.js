...
export default async function getPath(start, end) {
    try {
        const response = await axios.get(
        `https://api.mapbox.com/directions/v5/mapbox/cycling/${start.long},${start.lat};${end.long},${end.lat}?steps=true&geometries=geojson&access_token=${import.meta.env.VITE_MAP_TOKEN}`,
