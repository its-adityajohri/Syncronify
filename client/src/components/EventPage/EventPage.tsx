  ...
  return (
    <div className="w-full h-full bg-white text-black font-sans">
      ...
      <div className="search-bar text-center p-2">
        <input
          type="text"
          className="search-input w-2/3 px-4 py-2 shadow-lg outline-none border-[1px] border-gray-400 bg-white text-black rounded-full"
        ...
        <button
          className="w-20 bg-[#0f172a] text-white py-2 m-2 rounded-full  hover:outline-none border-2 border-gray-500 hover:bg-white p-2 hover:text-[#0f172a] text-center gap-2 text-bold"
          onClick={clearSearch}
        >Search
        </button>
      </div>
