...
import User from "../src/models/user.model"; // Update paths as necessary
import OneToOneMessage from "../src/models/message.model"; // Update paths as necessary
...
export function initializeSocketService(httpServer: HttpServer) {
  ...
  io.on("connection", (socket: Socket) => {
    ...
    socket.on("addUser", async (userId: string, userType: string) => {
      try {
