...
// import resetPasswordMail from "../templates/mail/resetPasswordMail";
...
// export const sendOTP = catchAsync(async (req : any, res : Response, next : NextFunction) => {
...
// export const verifyOTP = catchAsync(async (req : CustomRequest, res : Response, next : NextFunction) => {
